...
export function computeGamification(input: GamificationInput): GamificationState {
  ...
  const badges: Badge[] = [
    ...
    badge('first_quest', 'First Spark', 'Complete your first Momentum Quest', counts.get('quest_completed') ?? 0, 1, 'common', 25),
    badge('quests_7', 'Momentum Maker', 'Complete seven Momentum Quests', counts.get('quest_completed') ?? 0, 7, 'uncommon', 100),
    badge('quests_25', 'Quest Rhythm', 'Complete 25 Momentum Quests', counts.get('quest_completed') ?? 0, 25, 'rare', 220),
