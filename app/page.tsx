...
const TRANSLATIONS = {
  english: {
    // Hero
    heroBadge: "AI-Powered Standalone Personal Coach",
    heroTitle1: "TRAIN.",
    heroTitle2: "PLAY.",
    heroTitle3: "PERFORM.",
    heroDesc: "India's smartest standalone personal training platform — custom AI workout plans, AI nutrition tracking, body metrics, and local Llama coach at home or gym.",
    ...
    // Status Banner
    statusLive: "🏋️ Standalone AI Trainer is NOW LIVE — members can sign up, track progress, and get custom AI workouts & diet plans today.",
    statusComing: "Coming soon: Badminton, Cricket, Football & Yoga customized modules.",

    // Sports Section
    sportsEyebrow: "Activities Covered",
    sportsTitle: "YOUR SPORTS COMPANION",
    sportsDesc: "We are live with direct-to-consumer Gym coaching features, and expanding to all sports activities soon.",
    ...
    featDesc: "FitCore AI is a complete personal fitness ecosystem. Everything you need to optimize progress, right in your pocket.",
    ...
    otpTitle: "Password-less Email OTP",
    otpDesc: "Log in quickly and securely with your email address using Resend OTP verification. No passwords needed.",
    attendanceTitle: "Workout Streak Calendar",
    attendanceDesc: "Check off exercises in your daily workout list to automatically build daily consistency streaks and visual heatmaps.",
    ...
    // How It Works
    howBadge: "100% Direct AI Coaching",
    howTitle: "HOW FITCORE AI WORKS",
    howDesc: "Four simple steps to transform your training and nutrition with direct AI coaching.",
    step1Title: "Set Up Profile",
    step1Desc: "Enter your body details, target goals, allergies, and available equipment (Home or Gym).",
    step2Title: "Generate Plans",
    step2Desc: "Our local Llama AI generates a customized workout split and a detailed 7-day Indian nutrition plan.",
    step3Title: "Complete & Track",
    step3Desc: "Log your weight and tick off exercises in your checklist to grow your streak calendar.",
    step4Title: "Consult AI Coach",
    step4Desc: "Chat with the AI Coach anytime for form guidance, recipe alternatives, and fitness tips.",
  ...
  hinglish: {
    ...
    heroTitle2: "PLAY.",
    heroTitle3: "PERFORM.",
    heroDesc: "India ka sabse smart standalone personal training platform — custom AI workout plans, AI nutrition logs, progress tracking, aur local Llama coach, ghar ya gym me.",
    ...
    // Status Banner
    statusLive: "🏋️ Standalone AI Trainer ab LIVE hai — members sign up karke custom AI workouts aur diet plans instantly access kar sakte hain.",
    statusComing: "Jald hi aayega: Badminton, Cricket, Football aur Yoga customized modules.",

    // Sports Section
    sportsEyebrow: "Activities Covered",
    sportsTitle: "YOUR SPORTS COMPANION",
    sportsDesc: "Hum Gym coaching features ke saath live hain, aur baaki sports activities ko jald hi platform par laa rahe hain.",
    gymDesc: "Full weight tracking, AI workout checklist, daily macro meal planner aur chat trainer — sab kuch ek dashboard par.",
    ...
    featEyebrow: "Platform Features",
    featTitle: "SMART FEATURES BUILT IN",
    featDesc: "FitCore AI ek complete personal fitness ecosystem hai. Progress track karne ke liye har jaruri tool aapke phone me.",
    ...
    otpTitle: "Password-less Email OTP",
    otpDesc: "Email ID aur verification code ke jariye secure aur instant login. Passwords yaad rakhne ki koi jhanjhat nahi.",
    attendanceTitle: "Workout Streak Calendar",
    attendanceDesc: "Daily workout tasks tick karein aur daily workout streaks build karke tracking calendar check karein.",
    alertsTitle: "Automated Expiry & Smart Alerts",
    alertsDesc: "Plan updates aur updates ke liye direct WhatsApp aur SMS alerts paayein.",
    walletTitle: "Wallet & Referral Credits",
    ...
    howBadge: "100% Direct AI Coaching",
    howTitle: "HOW FITCORE AI WORKS",
    howDesc: "Direct AI trainer aur nutrition coach ke saath start karne ke 4 simple steps.",
    step1Title: "Profile Setup Karein",
    step1Desc: "Apne body stats, fitness goals, allergies aur available equipment details fill karein.",
    step2Title: "Plans Generate Karein",
    step2Desc: "Humara AI engine aapke liye custom workout schedule aur 7-day Indian diet structure banata hai.",
    step3Title: "Track & Grow Streaks",
    step3Desc: "Daily weight log karein aur exercises check karke consistency streak calendar build karein.",
    step4Title: "AI Coach Se Baat Karein",
    step4Desc: "Form tips, meal alternatives aur exercises ke baare me AI Coach se instantly salah lein.",
          ...
          <div className="landing-right-panel">
            <div className="landing-feature-list">
              ...
              <div className="landing-feat">
                <div className="landing-feat-icon purple">✅</div>
                <div>
                  <div className="landing-feat-title">{lang === 'hinglish' ? 'Streak Tracker' : 'Streak Tracker'}</div>
                  <div className="landing-feat-sub">{lang === 'hinglish' ? 'Weekly workout checklist complete karein aur streak heatmap banayein' : 'Complete weekly workout checklists to build your streak heatmap'}</div>
                </div>
              </div>
